...
function  [x] = bubble(A)
  ...
  for j = (mc_t15 : mc_t7);
    ...
    for i = (mc_t14 : mc_t6);
      [mc_t1] = A(i);                     % mc_t1=(double,[1, 1],{REAL})
      mc_t10 = 1;                         % mc_t10=(double,1.0,[1, 1],{REAL})
      [mc_t4] = plus(i, mc_t10);          % mc_t4=(double,[1, 1],{REAL})
      [mc_t2] = A(mc_t4);                 % mc_t2=(double,[1, 1],{REAL})
      [mc_t13] = gt(mc_t1, mc_t2);        % mc_t13=(logical,[1, 1],{REAL})
      if mc_t13
        ...
        A(i) = mc_t0;                       % A=(double,[1, 1],{REAL})
        mc_t12 = 1;                         % mc_t12=(double,1.0,[1, 1],{REAL})
        [mc_t3] = plus(i, mc_t12);          % mc_t3=(double,[1, 1],{REAL})
        A(mc_t3) = temp;                    % A=(double,[1, 1],{REAL})
      else
      end
    end
  end
  x = A;                              % x=(double,[1, 1],{REAL})
end
